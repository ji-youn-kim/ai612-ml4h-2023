...
class Optimizer(object):
    ...
    def optimizer(self):
        ...
        if not isinstance(self._optimizer, torch.optim.Optimizer):
            raise ValueError("_optimizer muse be an instance of torch.optim.Optimizer")
    ...
    def __getstate__(self):
        return self._optimizer__getstate__()
    ...
    def broadcast_global_state_dict(self, state_dict):
        ...
        if hasattr(self.optimizer, "broadcast_global_state_dict"):
            return self.optimizer.broad_cast_global_state_dict(state_dict)
        else:
            return state_dict
